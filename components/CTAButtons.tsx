      ...
      <div className="flex flex-row gap-3">
        <a
          ...
          className="
            ...
            bg-zao-accent text-zao-bg text-xs sm:text-sm font-bold uppercase tracking-wider
            rounded hover:bg-zao-accent-hover hover:shadow-[0_0_15px_rgba(73,243,195,0.4)]
        ...
        <a
          ...
          className="
            ...
            border border-zao-accent/30 text-zao-accent text-xs sm:text-sm font-bold uppercase tracking-wider
